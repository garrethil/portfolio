  ...
  return (
    <div className="project-card bg-white shadow-md rounded-lg p-4 relative group overflow-hidden">
      ...
      <div className="relative overflow-hidden">
        ...
        />
        {/* Overlay */}
        <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 transition-opacity duration-300 opacity-0 group-hover:opacity-90">
